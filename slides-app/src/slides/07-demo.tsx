...
const beats = [
  ...
  { n: 3, text: <><strong className="text-text-primary">Click causal explanation.</strong> Claude + Gemini agree. Score pinned to IPFS. &ldquo;Consensus confirmed. Score 68 &middot; Latency 72h &middot; Coverage 88% &middot; ipfs://Qm...&rdquo;</> },
